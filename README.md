...
I'm an MCA candidate at IMSCDR, Ahmednagar, with a passion for turning raw
data into business insight. I enjoy digging past headline numbers to find
...
**Languages & Data Analysis:** Python (Pandas, NumPy, Scikit-learn), SQL, PostgreSQL
**Visualization & BI:** Power BI, Matplotlib, MS Excel
**Machine Learning:** Supervised & unsupervised learning, classification, regression
**Web:** HTML, CSS
**Tools & Platforms:** Git, VS Code, IntelliJ IDEA

##  How to reach me

-  Email: [tejasteke2001@gmail.com](mailto:tejasteke2001@gmail.com)
-  Phone: +91 8625014941
-  LinkedIn: [linkedin.com/in/tejas-teke](https://linkedin.com/in/tejas-teke)
